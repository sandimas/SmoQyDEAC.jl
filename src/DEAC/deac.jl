...
function DEAC(correlation_function::AbstractVector,
    ...
    #
    return run_DEAC(correlation_function,correlation_function_error,params,autoresume_from_checkpoint,keep_bin_data)
end    

# Run the DEAC algorithm
function run_DEAC(correlation_function::AbstractVector,
                  correlation_function_error::AbstractVector,
